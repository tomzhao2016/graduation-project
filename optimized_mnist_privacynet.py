...
class privacyNetV3(privacyNet):
    ...
    def build_optimizer(self):
        ...
        for i in range(self.y_size):
            ...
            self.transform_train.append(K.function([self.input_t_trans_feat[i],self.input_t_real_feat[i]],
        ...
        for j in range(self.start_epoch, self.num_epochs):
            ...
            for i in range(self.celeba_generator.steps_per_epoch):
                ...
                for ind_t in range(self.y_size):
                    ...
                    print(input_t_real)
                    print(input_t_trans.shape)
                    errT.append(self.transform_train[ind_t]([np.array(input_t_trans),np.array(input_t_real)]))
